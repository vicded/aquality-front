...
const ExcelExport = ({data, fileName}) => {
  ...
  return (
    <StyledButton size="small" disabled={isDisabled} variant="outlined" onClick={(e) => exportToCSV(data, fileName)} color="success"> Descargar </StyledButton>
  );
}
